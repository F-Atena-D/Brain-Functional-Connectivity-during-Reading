function [plv] = eegPLV(eegData, srate, filtSpec, dataSelectArr)
...
filteredData(channelCount, :, :) = reshape(filtfilt(filtPts, 1, reshape(double(squeeze(eegData(channelCount, :, :))),[],1)), size(eegData,2), []);
end
